 ...
 *
 * @see org.osflash.statemachine.StateModel#transitionTo()
 */
public class StateTransitionError extends Error {
    public static const ALREADY_TRANSITIONING:String = "Can not invoke a transition when FSM is already transitioning.";
