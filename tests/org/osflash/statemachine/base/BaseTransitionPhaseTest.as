...
public class BaseTransitionPhaseTest {


    private var phase:BaseTransitionPhase;
    ...
    public function before():void {
        ...
        phase = new BaseTransitionPhase(PHASE_NAME, PHASE_INDEX);
    }
    ...
    public function equals_testAgainstUnequalTransitionPhase_shouldReturnFalse():void {
        var unequalPhase:ITransitionPhase = new BaseTransitionPhase( PHASE_NAME_UNEQUAL, PHASE_INDEX_UNEQUAL);
