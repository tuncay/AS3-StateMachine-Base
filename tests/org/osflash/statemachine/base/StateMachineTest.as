...
public class StateMachineTest implements ITransitionRegister {
    ...
    public function invalid_transition_throws_StateTransitionError():void {
        ...
        var expectedMessage:String = StateTransitionError.INVALID_TRANSITION_ERROR;
        expectedMessage = injectToken( expectedMessage, "phase", getNullUID().toString() );
        setGrumpyValidators();
    ...
    public function invalid_cancellation_throws_StateTransitionError():void {
        ...
        var expectedMessage:String = StateTransitionError.INVALID_CANCEL_ERROR;
        expectedMessage = injectToken( expectedMessage, "phase", getNullUID().toString() );
        setGrumpyValidators();
